...
public class Send extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchEditText = findViewById(R.id.search_edit_text_send);
        backIcon = findViewById(R.id.backIcon);
        cancelText = findViewById(R.id.cancel_text_send);
        tokenRecyclerView = findViewById(R.id.token_recycler_view_send);

        if (searchEditText == null || backIcon == null || cancelText == null || tokenRecyclerView == null) {
